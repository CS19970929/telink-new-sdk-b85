...
foreach ($file in @("Shared/BmsDiagnostics.cs", "Shared/BmsHealth.cs", "Shared/BmsClient.Diagnostics.cs", "Shared/D008Parameters.cs", "Shared/Sh3673520Parameters.cs", "BmsTool.Windows/BmsClient.cs", "BmsTool.Windows/BmsTransport.cs", "BmsTool.Windows/ModbusRtu.cs", "Tests/DiagnosticsTest.cs")) {
