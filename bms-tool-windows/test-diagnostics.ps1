...
foreach ($file in @("Shared/SocInputRecording.cs", "Tests/SocInputRecordingTest.cs", "Shared/BmsDiagnosticSession.cs", "Tests/DiagnosticSessionTest.cs", "Shared/BmsDiagnostics.cs", "Shared/BmsHealth.cs", "Shared/BmsTestEngine.cs", "Shared/ProductSupport.cs", "Shared/BmsClient.Diagnostics.cs", "Shared/D008Parameters.cs", "Shared/Sh3673520Parameters.cs", "Shared/SocRecording.cs", "BmsTool.Windows/BmsClient.cs", "BmsTool.Windows/BmsTransport.cs", "BmsTool.Windows/ModbusRtu.cs", "Tests/DiagnosticsTest.cs")) {
