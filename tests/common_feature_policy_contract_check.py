...
for symbol in ("bms_afe_get_feature_snapshot","bms_afe_set_balance_mask","bms_afe_get_balance_mask","bms_afe_openwire_start","bms_afe_openwire_poll"): assert symbol in afe_h
sh=text("sh3673510_feature_backend.c")
for token in ("SH3673520_SCONF3_OWD_EN_MASK","SH3673520_SCONF3_OWD_TRG_MASK","SH3673520_REG_FLAG3","SH3673520_REG_OWDH","0x000AAAAA","0x00055555","SH_FEATURE_BALANCE_REFRESH_SAMPLES 100u"): assert token in sh,token
