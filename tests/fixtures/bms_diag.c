...
struct PRT_E2ROM_PARAS{int dummy;};
...
static int dvc_comm_range_contains(u16 r,u16 n){return 0;}
static void btname_modbus_on_write_holding(u8 a,u16 n,const u16*p){writes++;}
/* MODBUS */
