...
#define FLASH_ADDR_LAYOUT_512K_RUN_KV_BASE_PREV      0x70000u
#define FLASH_ADDR_LAYOUT_512K_SOFT_PROTECT_PREV     0x72000u

#define FLASH_ADDR_LAYOUT_1M_RUN_KV_BASE_PREV        0xC3000u
#define FLASH_ADDR_LAYOUT_1M_SOFT_PROTECT_PREV       0xC5000u

#define FLASH_ADDR_LAYOUT_2M_RUN_KV_BASE_PREV        0x1C3000u
#define FLASH_ADDR_LAYOUT_2M_SOFT_PROTECT_PREV       0x1C5000u

#define FLASH_ADDR_PREV_RUN_KV_SECTORS               2u
#define FLASH_ADDR_PREV_COLD_KV_SECTORS              2u
...
static inline u32 flash_store_cfg_get_previous_soc_kv_base(void)
{
    if (blc_flash_capacity == FLASH_SIZE_1M) {
        return FLASH_ADDR_LAYOUT_1M_RUN_KV_BASE_PREV;
    }
    if (blc_flash_capacity == FLASH_SIZE_2M) {
        return FLASH_ADDR_LAYOUT_2M_RUN_KV_BASE_PREV;
    }
    return FLASH_ADDR_LAYOUT_512K_RUN_KV_BASE_PREV;
}

static inline u16 flash_store_cfg_get_previous_soc_kv_sectors(void)
{
    return FLASH_ADDR_PREV_RUN_KV_SECTORS;
}
...
static inline u32 flash_store_cfg_get_previous_cold_kv_base(void)
{
    if (blc_flash_capacity == FLASH_SIZE_1M) {
        return FLASH_ADDR_LAYOUT_1M_SOFT_PROTECT_PREV;
    }
    if (blc_flash_capacity == FLASH_SIZE_2M) {
        return FLASH_ADDR_LAYOUT_2M_SOFT_PROTECT_PREV;
    }
    return FLASH_ADDR_LAYOUT_512K_SOFT_PROTECT_PREV;
}

static inline u16 flash_store_cfg_get_previous_cold_kv_sectors(void)
{
    return FLASH_ADDR_PREV_COLD_KV_SECTORS;
}
