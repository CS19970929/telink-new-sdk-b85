...
void Param_UpgradeReset_Apply(void)
{
    ...
    if (param_upgrade_epoch_mismatch(BMS_COLD_CTRL_PROTECT_RESET_EPOCH,
                                     FW_UPGRADE_RESET_PROTECT_EPOCH))
    {
        if (param_upgrade_apply_default_protect())
        {
            param_upgrade_mark_epoch(BMS_COLD_CTRL_PROTECT_RESET_EPOCH,
                                     FW_UPGRADE_RESET_PROTECT_EPOCH);
        }
        else
        {
    ...
    if (param_upgrade_epoch_mismatch(BMS_COLD_CTRL_SYSTEM_RESET_EPOCH,
                                     FW_UPGRADE_RESET_SYSTEM_EPOCH))
    {
        if (param_upgrade_apply_default_system())
        {
            param_upgrade_mark_epoch(BMS_COLD_CTRL_SYSTEM_RESET_EPOCH,
                                     FW_UPGRADE_RESET_SYSTEM_EPOCH);
        }
        else
        {
    ...
    if (param_upgrade_epoch_mismatch(BMS_COLD_CTRL_SOC_RESET_EPOCH,
                                     FW_UPGRADE_RESET_SOC_EPOCH))
    {
        if (param_upgrade_apply_default_soc())
        {
            param_upgrade_mark_epoch(BMS_COLD_CTRL_SOC_RESET_EPOCH,
                                     FW_UPGRADE_RESET_SOC_EPOCH);
        }
        else
        {
    ...
    if (param_upgrade_epoch_mismatch(BMS_COLD_CTRL_EVENT_LOG_RESET_EPOCH,
                                     FW_UPGRADE_RESET_EVENT_LOG_EPOCH))
    {
        if (param_upgrade_apply_default_event_log())
        {
            param_upgrade_mark_epoch(BMS_COLD_CTRL_EVENT_LOG_RESET_EPOCH,
                                     FW_UPGRADE_RESET_EVENT_LOG_EPOCH);
        }
        else
        {
    ...
    if (param_upgrade_epoch_mismatch(BMS_COLD_CTRL_RUNTIME_RESET_EPOCH,
                                     FW_UPGRADE_RESET_RUNTIME_EPOCH))
    {
        if (param_upgrade_apply_default_runtime())
        {
            param_upgrade_mark_epoch(BMS_COLD_CTRL_RUNTIME_RESET_EPOCH,
                                     FW_UPGRADE_RESET_RUNTIME_EPOCH);
        }
        else
        {
