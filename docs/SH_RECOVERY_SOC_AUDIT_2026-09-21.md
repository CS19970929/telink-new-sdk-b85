# D013 SOC 接入、恢复与 CI 修复（2026-09-21）

基线 `f41193c`，分支 `refactor/d013-common-bms-features`。本轮不改产品 IO、参数/Flash 布局、OTA 格式或 AFE 寄存器定义。完整跨产品审核在 D008 分支 `docs/BMS_ENGINEERING_AUDIT_2026-09-21.md`。
...
- 正式BIN：110228 B；SHA-256 `28d412123d4001613956733a1df15bd5ca2ec7027ea82c90597e0b706d61ea5f`。
- `_ram_use_end_ = 0x845db0`；`__SRAM_SIZE = 0x848000`；扣除600B栈预留的地址余量 8184 B。
